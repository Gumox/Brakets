...
import ShopStepThreex from './pages/stepThree/ShopStepThreex';
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator >
        ...
        <Stack.Screen name="ShopStepThreex" component={ShopStepThreex} options={{ title: '3단계' ,headerTitleAlign: 'center'}} />
