...
import StaffRegist from "../../components/adminStore/staffRegist";

const AdminStaffRegist = ({user,infos,brands,staffs}) => {
  ...
  return (
    ...
    <AdminStoreHeader user={user}/>
      <InSideWrapper>
        <SidebarSpace  style={{minHeight:`${windowHeight-320}px`}}>
            <AdminStoreLeftSidebar/>
        </SidebarSpace>
        <MainSpace  style={{height:windowHeight}}>
            <StaffRegist staffs={staffs}/>
        </MainSpace>
      </InSideWrapper>
    </Wrapper>
  );
...
`;
export default AdminStaffRegist;
