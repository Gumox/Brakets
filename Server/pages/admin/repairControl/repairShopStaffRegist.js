    ...
    <Wrapper style={{height:`${windowHeight}px`}}>
      ...
      <InSideWrapper>
        <SidebarSpace  style={{minHeight:`${windowHeight-150}px`}}>
          <RepairSideBar path={"/admin/repairControl/repairShopStaffRegist"}/>
        </SidebarSpace>
        <MainSpace >
            <StaffRegist repairShops={repairShopsList} staffs={staffs}/>
        </MainSpace>
      </InSideWrapper>
    </Wrapper>
  );
...
export default RepairControlRepairShopStaffRegist;
