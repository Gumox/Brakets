...
import StoreStaffRegist from "../../../components/admin/store/storeStaffRegist";
...
const StoreControl = ({user,store,brands,storeStaffs}) => {
    ...
    return (
        ...
        <InSideWrapper>
            ...
            <StoreSideBar path={"/admin/storeControl/storeStaffRegist"}/>
            </SidebarSpace>
            <MainSpace >
                <StoreStaffRegist stores={store}/>
            </MainSpace>
        </InSideWrapper>
...
export const getServerSideProps = async (ctx) => {
    ...
    if (!isAuthorized) {
        ...
        const [storeStaffs] = await Promise.all([
            axios
