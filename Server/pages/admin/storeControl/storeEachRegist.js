...
import StoreEachRegist from "../../../components/admin/store/storeEachRegist";

const StoreControlStoreEachRegidt = ({user,infos,brands,store}) => {
    ...
    <Wrapper style={{height:`${windowHeight}px`}}>
      ...
      <InSideWrapper>
        <SidebarSpace  style={{minHeight:`${windowHeight-120}px`}}>
          <StoreSideBar path={"/admin/storeControl/storeEachRegist"}/>
        </SidebarSpace>
        <MainSpace >
          <StoreEachRegist brands={brands} stores={store}/>
        </MainSpace>
      </InSideWrapper>
...
`;
export default StoreControlStoreEachRegidt;
