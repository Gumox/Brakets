...
import CategoryList from "../../../components/admin/brand/category";

const BrandControlcategoryList =  ({user,infos,categorys,brands}) => {
  ...
  return (
    <Wrapper style={{height:`${windowHeight}px`}}>
      ...
      <InSideWrapper>
        ...
        <MainSpace >
            <CategoryList brands={brands} categorys={categorys}/>
        </MainSpace>
      </InSideWrapper>
    </Wrapper>
  );
...
export const getServerSideProps = async (ctx) => {
    ...
    const [categorys] = await Promise.all([
        axios
            .get(`${process.env.API_URL}/brand/getCategoryInHeadquarter?headquarterId=${user.headquarter_id}`,)
            .then(({ data }) => data.body), 
    ])
...
export default BrandControlcategoryList;
