...
import SeasonRegist from "../../../components/admin/brand/season/SeasonRegist";

const BrandControlSeasonRegist =  ({user,infos,season,brands}) => {
    ...
    <Wrapper style={{height:`${windowHeight}px`}}>
      ...
      <InSideWrapper>
        <SidebarSpace  style={{minHeight:`${windowHeight-120}px`}}>
          <BrandSideBar path={"/admin/brandControl/seasonRegist"}/>
        </SidebarSpace>
        <MainSpace >
            <SeasonRegist brands={brands}/>
        </MainSpace>
      </InSideWrapper>
    </Wrapper>
  );
...
export default BrandControlSeasonRegist;
