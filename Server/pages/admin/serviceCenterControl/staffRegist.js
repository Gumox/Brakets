...
import StaffRegist from "../../../components/admin/serviceCenter/staffRegist";

const ServiceCenterStaffList = ({infos,user,staffs}) => {
  ...
  return (
    <Wrapper style={{height:`${windowHeight}px`}}>
      ...
      <InSideWrapper>
        ...
        <MainSpace >
          <StaffRegist infos={infos[0]} staffs={staffs} user={user}/>
        </MainSpace>
      </InSideWrapper>
    </Wrapper>
  );
