...
const ReturnList = ({ data, user }) => {
  ...
  const columns = React.useMemo(() => [
    ...
    const value = data.map((pairRepair) => ({
      ...
      "판매가":pairRepair[PRODUCT.TAG_PRICE]? numberWithCommas(pairRepair[PRODUCT.TAG_PRICE]):"",
      "고객요구":RECEIPT_TYPE[pairRepair[RECEIPT.TYPE]],
      "매장접수내용":pairRepair[RECEIPT.STORE_MESSAGE],
      "고객약속일":pairRepair[RECEIPT.DUE_DATE]? moment(pairRepair[RECEIPT.DUE_DATE]).format("YYYY-MM-DD"): "",
      ...
      "유상수선비":pairRepair.fee? numberWithCommas(pairRepair.fee):"",
      "유상수선 유/무":(pairRepair.fee > 0) ? "유" : "무",

      "수선처1": pairRepair.repair1_store_name ?  pairRepair.repair1_store_name : "",
      "총수선비1": pairRepair.repair1_repair1_price ?  numberWithCommas(pairRepair.repair1_repair1_price + pairRepair.repair1_repair2_price + pairRepair.repair1_repair3_price ) : "",
      "수선처접수일1": pairRepair.repair1_register_date ? moment(pairRepair.repair1_register_date).format("YYYY-MM-DD") : "",
      "재수선1": (pairRepair.repair1_repair1_redo > 0 || pairRepair.repair1_repair2_redo > 0 || pairRepair.repair1_repair3_redo > 0) ? ("Y") : ("N"),
      "수선처2":  pairRepair.repair2_store_name ?  pairRepair.repair2_store_name : "",
      "총수선비2":  pairRepair.repair2_repair1_price ?  numberWithCommas(pairRepair.repair2_repair1_price + pairRepair.repair2_repair2_price + pairRepair.repair2_repair3_price ) : "",
      "수선처접수일2": pairRepair.repair2_register_date ? moment(pairRepair.repair2_register_date).format("YYYY-MM-DD") : "",
      "재수선2": (pairRepair.repair2_repair1_redo > 0 || pairRepair.repair2_repair2_redo > 0 || pairRepair.repair2_repair3_redo > 0) ? ("Y") : ("N"),
      "수선처3":  pairRepair.repair3_store_name ?  pairRepair.repair3_store_name : "",
      "총수선비3":  pairRepair.repair3_repair1_price ?  numberWithCommas(pairRepair.repair3_repair1_price + pairRepair.repair3_repair2_price + pairRepair.repair3_repair3_price ) : "",
      "수선처접수일3": pairRepair.repair3_register_date ? moment(pairRepair.repair3_register_date).format("YYYY-MM-DD") : "",
      "재수선3": (pairRepair.repair3_repair1_redo > 0 || pairRepair.repair3_repair2_redo > 0 || pairRepair.repair3_repair3_redo > 0) ? ("Y") : ("N"),
      "생산업체": pairRepair.manufacturer_name,
      "발송일 to M":  pairRepair.mfr_send_date ?  moment(pairRepair.mfr_send_date).format("YYYY-MM-DD") : "",
      "본사설명": pairRepair.message,
      "하자코드":"",
